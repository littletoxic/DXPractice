...
internal sealed class DX12Engine {
    ...
    private static readonly List<string> TextureNames = [
        "resource/diamond_ore.png",                     // 0.钻石原矿
    ...
    private unsafe void STEP11_CreateCameraCBVResource() {
        ...
        for (var y = -12; y <= 12; y += 6) {
            for (var z = -24; z <= 24; z += 6) {
                for (var x = 0; x < 25; x++) {
                    ...
                    float blockZ = z;
                    var blockTypeIndex = (uint)random.Next(_blockCubeTextureIndexGroup.Length);
