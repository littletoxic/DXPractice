...
internal sealed class DX12Engine {
    ...
    private void CreateWBOITResources() {
        ...
        _wboitBarrierToSRV.Transition.StateBefore = D3D12_RESOURCE_STATE_RENDER_TARGET;
        _wboitBarrierToSRV.Transition.StateAfter = D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE;

        _wboitBarrierToRTV.Type = D3D12_RESOURCE_BARRIER_TYPE_TRANSITION;
        _wboitBarrierToRTV.Transition.StateBefore = D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE;
        _wboitBarrierToRTV.Transition.StateAfter = D3D12_RESOURCE_STATE_RENDER_TARGET;
    }
