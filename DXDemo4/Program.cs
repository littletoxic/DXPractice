// https://blog.csdn.net/DGAF2198588973/article/details/145232320
...
internal sealed class DX12Engine {
    ...
    private void CreateUploadAndDefaultResource() {
        ...
        _uploadResourceRowSize = (_bytesPerRowSize + D3D12_TEXTURE_DATA_PITCH_ALIGNMENT - 1) & ~(D3D12_TEXTURE_DATA_PITCH_ALIGNMENT - 1);
    ...
    private unsafe void CreateVertexResource() {
        ReadOnlySpan<Vertex> vertices = [
            new() { Position = new(-0.75f, 0.75f, 0f, 1f), TexCoordUV = new(0f, 0f) },
            new() { Position = new(0.75f, 0.75f, 0f, 1f), TexCoordUV = new(1f, 0f) },
            new() { Position = new(0.75f, -0.75f, 0f, 1f), TexCoordUV = new(1f, 1f) },
            new() { Position = new(-0.75f, 0.75f, 0f, 1f), TexCoordUV = new(0f, 0f) },
            new() { Position = new(0.75f, -0.75f, 0f, 1f), TexCoordUV = new(1f, 1f) },
            new() { Position = new(-0.75f, -0.75f, 0f, 1f), TexCoordUV = new(0f, 1f) },
        ];
