...
internal static class Extensions {
    ...
    // ID3D11On12Device 实例扩展
    internal static void CreateWrappedResource<T>(this ID3D11On12Device @this, object pResource12, in D3D11_RESOURCE_FLAGS pFlags11, D3D12_RESOURCE_STATES InState, D3D12_RESOURCE_STATES OutState, out T resource) where T : class, ID3D11Resource {
        @this.CreateWrappedResource(pResource12, pFlags11, InState, OutState, typeof(T).GUID, out object result);
        resource = (T)result;
    }

    internal static unsafe void CreateWrappedResource(this ID3D11On12Device @this, object pResource12, in D3D11_RESOURCE_FLAGS pFlags11, D3D12_RESOURCE_STATES InState, D3D12_RESOURCE_STATES OutState, in Guid riid, out object resource) {
        @this.CreateWrappedResource(pResource12, pFlags11, InState, OutState, riid, out void* __ppResource11_native);

        resource = ComInterfaceMarshaller<object>.ConvertToManaged(__ppResource11_native);
        ComInterfaceMarshaller<object>.Free(__ppResource11_native);
    }
